<div id="kt_app_sidebar" 
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo" >
        ...
        <a target="_blank" href="{{ url('/')}}">
                              ...
                              <img src="{{ url('/img/wpn-logo_v2.png') }}" alt="Logo" class=" app-sidebar-logo-default" style="height:60px" />
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid" >
        ...
        <div id="kt_app_sidebar_menu_wrapper"  class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/MyUser*')) ? 'active' : '' }}" href="{{ url('/admin/MyUser') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link {{ (request()->is('admin/category*')) ? 'active' : '' }}" href="{{ url('admin/category') }}">
                        ...
                        <span class="menu-title">หมวดหมู่เนื้อหา</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/branch*')) ? 'active' : '' }}" href="{{ url('admin/branch') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">จัดการแผนกต่างๆ</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/video*')) ? 'active' : '' }}" href="{{ url('admin/video') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">จัดการไฟล์ Video</span>
                    </a>
                    <!--end:Menu link-->
                </div>
