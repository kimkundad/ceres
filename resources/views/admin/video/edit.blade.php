                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">แก้ไขวิดีโอใหม่</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <form id="kt_account_profile_details_form" class="form" method="POST" action="{{$url}}" enctype="multipart/form-data">
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">รูปภาพ</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <!--begin::Image input-->
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('img/dummy-logo.png') }}')">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ url('img/video_img/'.$objs->video_img) }})"></div>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">ชื่อวิดีโอ</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="video_name" class="form-control form-control-lg form-control-solid" placeholder="เนื้อหาที่ 1" value="{{ $objs->video_name }}">
                                    
                                        @if ($errors->has('video_name'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div>กรุณากรอกชื่อวิดีโอ</div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">รายละเอียด</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <textarea class="form-control form-control-lg form-control-solid" id="textareaAutosize" placeholder="รายละเอียดแบบย่อ..." rows="3" name="video_detail" >{{ $objs->video_detail }} </textarea>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" name="branch_id" aria-label="Select example">
                                            @isset($branch)
                                                @foreach ($branch as $item)
                                                    <option value="{{ $item->id }}" @if( $objs->branch_id == $item->id)
                                                        selected='selected'
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">หมวดหมู่วิดีโอ</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" name="cat_id" aria-label="Select example">
                                            @isset($cat)
                                                @foreach ($cat as $item)
                                                    <option value="{{ $item->id }}" @if( $objs->cat_id == $item->id)
                                                        selected='selected'
                                                        @endif>{{ $item->cat_name }}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                        @if ($errors->has('cat_id'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div>กรุณากำหนด หมวดหมู่วิดีโอ</div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--end::Col-->
