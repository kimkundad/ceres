                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">วิดีโอ</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/video/create') }}" class="btn btn-sm fw-bold btn-primary" >
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">วิดีโอ ทั้งหมด</span>
                                <span class="text-muted mt-1 fw-semibold fs-7"> {{ count($objs) }} ไฟล์</span>
                            </h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="p-0 "></th>
                                            <th class="p-0 ">ชื่อเนื้อหา</th>
                                            <th class="p-0 ">หมวดหมู่</th>
                                            <th class="p-0 ">แผนก</th>
                                            <th class="p-0 ">วันที่สร้าง</th>
                                            <th class="p-0 ">เปิด/ปิด การใช้งาน</th>
                                            <th class="p-0 "></th>
                                        </tr>
                                    </thead>
                                    <!--end::Table head-->
                                        ...
                                        <tr id="{{$item->id_q}}">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div>
                                                        <img src="{{ url('img/video_img/'.$item->video_img) }}" style="height:55px; border-radius: 0.475rem;">
                                                    </div>
                                                    <!--end::Avatar-->
                                                </div>
                                            </td>
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->video_name }}</a>
                                            </td>
                                            <td>
                                                {{ $item->cat_name }}
                                            </td>
                                            <td>
                                                ...
                                                <span class="badge py-3 px-4 fs-7 badge-light-success"> {{ $item->b_name }}</span>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/video/'.$item->id_q.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_video/'.$item->id_q) }}"  onclick="return confirm('Are you sure?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<script type="text/javascript">
    $(document).ready(function(){
      $("input:checkbox").change(function() {
        ...
        $.ajax({
                type:'POST',
                url:'{{url('api/api_post_status_video')}}',
